...
Implements: |â_holistic| = sqrt(Î±|â_{x,y}I|Â² + Î²|â_Î»I|Â² + Î³|â_{x,y,Î»}I|Â²)
"""
...
class HolisticGradient(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            spectral_scales: (fine, medium, coarse) Ï_Î» values
        ...
        self.weight_mlp = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(0.15),
            nn.Linear(24, 12),  # 3 scales Ã 3 weights = 9? Actually 3 weights total
            nn.Sigmoid()
        )
    ...
    def _spatial_gradient(self, x: torch.Tensor) -> torch.Tensor:
        """
        Compute spatial gradient magnitude |â_{x,y}I|.
    ...
    def _spectral_gradient(self, x: torch.Tensor) -> torch.Tensor:
        """
        Compute spectral gradient magnitude |â_Î»I|.
    ...
    def _mixed_gradient(self, x: torch.Tensor) -> torch.Tensor:
        """
        Compute mixed partial derivative |â_{x,y,Î»}I|.
        
        Mixed gradient = sqrt(|â_x(â_Î»I)|Â² + |â_y(â_Î»I)|Â²)
        ...
        medium_filt = self.spectral_filters[1]  # Ï_Î» = 3
    ...
    def forward(
        ...
        # Predict conditioned weights Î±, Î², Î³ (Eq. 7.3)
