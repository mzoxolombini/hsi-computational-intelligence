...
if [ ! -f "Indian_Pines/Indian_pines_corrected.mat" ]; then
    ...
    echo "  â Indian Pines downloaded"
else
    echo "  â Indian Pines already exists"
fi
...
if [ ! -f "Pavia_University/PaviaU.mat" ]; then
    ...
    echo "  â Pavia University downloaded"
else
    echo "  â Pavia University already exists"
fi
...
if [ ! -f "Salinas/Salinas_corrected.mat" ]; then
    ...
    echo "  â Salinas downloaded"
else
    echo "  â Salinas already exists"
fi
...
if [ ! -f "Houston/Houston.mat" ]; then
    ...
    echo "  â  Houston dataset requires registration (not downloaded)"
else
    echo "  â Houston already exists"
fi
